...
class Controller(object):
    ...
    def __init__(self, *args, **kwargs):
        ...
        total_vehicle_mass = self.vehicle_mass + self.fuel_capacity * self.GAS_DENSITY  # 1.774,933
    ...
    def control(self, desired_linear_velocity, desired_angular_velocity, current_linear_velocity, dbw_enabled):
        ...
        steering = self.yaw_controller.get_steering(desired_linear_velocity, desired_angular_velocity,
